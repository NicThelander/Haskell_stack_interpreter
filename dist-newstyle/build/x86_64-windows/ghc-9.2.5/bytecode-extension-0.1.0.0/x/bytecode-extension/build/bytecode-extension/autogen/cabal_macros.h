...
/* package bytecode-extension-0.1.0.0 */
#ifndef VERSION_bytecode_extension
#define VERSION_bytecode_extension "0.1.0.0"
#endif /* VERSION_bytecode_extension */
#ifndef MIN_VERSION_bytecode_extension
#define MIN_VERSION_bytecode_extension(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bytecode_extension */
...
#define CURRENT_COMPONENT_ID "bytecode-extension-0.1.0.0-inplace-bytecode-extension"
